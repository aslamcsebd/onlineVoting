...
//    $details = $_POST['details'];
    ...
    $sql = "Insert Into election_winner (election_id,election_name,candidate_id,candidate_name,party_name) values ('$election_id','$election_name','$candidate_id','$candidate_name','$party_name')";
    $result = mysqli_query($vote, $sql);
        ...
        <div class="container">
            ...
            <div class="row contact-info">
                ...
                <div class="col-md-9 col-sm-8 col-xs-12 col-sm-offset-2">
                    ...
                    <h2>Select Winner Of Election</h2>
                        ...
                        <form action="" method="POST">
                            <tr>
                                ...
                                <td class="text-left">
                                    ...
                                    <select required name='election_id'
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    ...
                                    <select  required name='candidate_id'
                                            style="  background-color: #1abc9c; font-size: 17px; padding: 5px 0px;">
