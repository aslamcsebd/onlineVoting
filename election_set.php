...
<?php
   if (isset($_POST['add_election'])) {
      ...
      $sql ="insert into election_session values (null, '$date', '$election_type')";
      ...
      if ($result2) {
         $_SESSION['election_add_successfully']=true;
                  ...
                  <form action="" method="POST">
                     <tr>
                        ...
                        <td class="text-left">
                           ...
                           <select name='election_type' style="  background-color: #1abc9c; font-size: 17px; padding: 5px 0px; text-align: center;">
                     ...
                     <tr>
                        ...
                        <td class="text-left">
                           ...
                           <button type="submit" name="add_election" class="btn btn-primary" onclick="return confirm('Are you sure?')">Add Now
                           </button></td>                         
                     </tr>                     
                  </form>            
               </table>
